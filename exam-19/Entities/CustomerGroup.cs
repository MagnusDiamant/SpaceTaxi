...
namespace SpaceTaxi.Entities {
    public class CustomerGroup {
        ...
        ///     position right above the platform and a little to the right of the specific platform-
        ///     image is returned.
        /// </summary>
        /// <param name="platform"> The character representing the customers SpawnPlatform</param>
