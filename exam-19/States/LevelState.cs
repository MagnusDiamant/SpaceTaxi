...
namespace SpaceTaxi.States {
    public class LevelState : IGameState {
        ...
        public LevelState() {
            ...
            // The buttons level1, level2 and back are instantiated with a string displayed on the 
            // screen and a position and size 
            level1 = new Text("Level 1", new Vec2F(0.3f, 0.5f),
                new Vec2F(0.35f, 0.25f));
            level2 = new Text("Level 2", new Vec2F(0.3f, 0.4f),
                new Vec2F(0.35f, 0.25f));
            back = new Text("Main Menu", new Vec2F(0.3f, 0.3f),
                new Vec2F(0.35f, 0.25f));
        ...
        // In order for the LevelState class to be of the IGameState interface, there are 
